<template>
  <div class="isolate overflow-hidden bg-red-700">
    <div class=" relative mx-auto max-w-7xl px-6 mb-96 pt-24 text-center sm:pt-32 lg:px-8">
      <div class="mx-auto max-w-4xl">
        ...
        <p class="mt-2 text-4xl font-bold tracking-tight text-white sm:text-5xl">
          ...
          <br class="hidden sm:inline lg:hidden" />whoever you are
        </p>
      </div>
        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
          <div class="mx-auto grid max-w-md grid-cols-1 gap-8 lg:max-w-4xl lg:grid-cols-2">
            <div v-for="tier in tiers" :key="tier.id"
              ...
              <div>
                <h3 :id="tier.id" class="text-base font-semibold leading-7 text-indigo-600">
                  {{ tier.name }}
                </h3>
              ...
              <a :href="tier.href" :aria-describedby="tier.id"
                class="mt-8 block rounded-md bg-indigo-600 px-3.5 py-2 text-center text-sm font-semibold leading-6 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Get
                started today</a>
            </div>
            <div
